...
export default function MultipleChoice({ questionContent, answers, correctAnswers }: Props) {
    ...
    const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (event.target.checked) {
            ...
            setUserAnswers(userAnswers.filter((answer) => answer !== event.target.value)); // nếu user tick hai lần vào ô thì chỉ lưu vào mảng  1 lần
        } //answer: Đây là biến được sử dụng để đại diện cho mỗi phần tử trong mảng 
    };
